...
description: Transform a codebase into a literate program, producing a document that
  combines prose and runnable source code.
version: 0.1.0
author: Tobi Lehman
license: unknown
platforms:
...
metadata:
  hermes:
    ...
    source_repo: tlehman/litprog-skill
    required_commands:
    - bun
    - pandoc
    - xelatex
